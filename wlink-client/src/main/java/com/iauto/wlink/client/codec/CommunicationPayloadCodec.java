package com.iauto.wlink.client.codec;
 ...
 * 
 */
public class CommunicationPayloadCodec extends ByteToMessageCodec<CommunicationMessage> {
...
//			// 状态迁移到PAYLOAD_PROPERTIES
//			currentState = State.PAYLOAD_PROPERTIES;
//		case PAYLOAD_PROPERTIES:
//
//			// 如果Buffer中的可读字节数不够读取荷载属性，则等待下次通道可读时继续解析
//			if ( in.readableBytes() < this.propertiesLen )
//				return;
//
//			byte[] bytesProperties = new byte[this.propertiesLen];
//			in.readBytes( bytesProperties );
//
//			// 读取包头
//			this.commPayload.setProperties( bytesProperties );
